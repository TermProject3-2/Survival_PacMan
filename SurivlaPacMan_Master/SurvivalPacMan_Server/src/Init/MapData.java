...
public class MapData {
		...
		short   level1data[] = {  // screendata가  이미 leveldata값으로 초기화함
		...
		short   level2data[] = {
				0, 12, 19, 26, 26, 22, 9, 0, 12, 19, 26, 26, 22, 9, 0,
				12,19, 20, 11, 14, 17, 22,13,19, 20, 11, 14, 17, 22,9,
				43,16, 24, 26, 26, 16, 24,26,24, 16, 26, 26, 24, 16,46,
				6, 21, 3,  2,  6,  21, 11,2, 14, 21, 3,  2,  6,  21,3,
				12,21, 9,  8,  12, 17, 30,5, 27, 20, 9,  8,  12, 21,9,
				27,16, 18, 26, 18, 20, 11,8, 14, 17, 18, 26, 18, 16,30,
				6, 17, 28, 7,  25, 16, 26,42,26, 16, 28, 7,  25, 20,3,
				4, 21, 11, 0,  14, 21, 11,10,14, 21, 11, 0,  14, 21,1,
				12,17, 22, 13, 19, 16, 30,5, 27, 16, 22, 13, 19, 20,9,
				27,16, 16, 26, 16, 20, 11,8, 14, 17, 16, 26, 16, 16,30,
				6, 17, 28, 7,  25, 16, 26,18,26, 16, 28, 7,  25, 20,3,
				12,21, 3,  0,  6,  21, 15,21,15, 21, 3,  0,  6,  21,9,
				27,20, 9,  8,  12, 17, 18,24,18, 20, 9,  8,  12, 17,30,
				6, 25, 18, 26, 18, 16, 28,7, 25, 16, 18, 26, 18, 28, 3,
				0, 6,  45, 7,  25, 28, 3, 0, 6,  25, 28, 7,  45, 3, 0
		};
		
		short level3data[] = {
				12, 19, 26, 18, 22, 9, 0, 4, 27, 18, 26, 26, 26, 46, 9,
				19, 28, 7,  25, 16, 30,9, 8, 14, 21, 11, 10, 10, 6,  23,
				37, 11, 0,  14, 21, 15,19,26,26, 24, 26, 18, 22, 13, 21,
				25, 22, 13, 19, 24, 26,28,3, 10, 10, 6,  25, 16, 26, 20,
				14, 17, 18, 28, 11, 10,10,4, 19, 22, 9,  6,  21, 7,  21,
				19, 24, 20, 15, 19, 26,22,5, 17, 24, 22, 13, 21, 13, 21,
				29, 7,  17, 18, 28, 15,29,13,45, 15, 25, 18, 24, 26, 20,
				10, 4,  25, 20, 15, 23,11,10,14, 23, 15, 21, 3,  6,  29,
				23, 9,  14, 17, 18, 16,30,5, 27, 16, 18, 20, 9,  8,  10,
				25, 18, 18, 24, 16, 20,11,8, 14, 17, 16, 24, 18, 18, 30,
				14, 17, 28, 15, 17, 16,18,18,18, 24, 20, 15, 25, 20, 11,
				19, 28, 7,  19, 16, 24,16,16,28, 15, 17, 22, 7,  25, 22,
				21, 11, 4,  25, 28, 7, 17,20,7,  27, 24, 28, 1,  14, 21,
				25, 22, 1,  2,  10, 12,17,20,9,  10, 2,  2,  12, 19, 28,
				6,  45, 1,  4,  27, 26,24,24,26, 30, 1,  4,  27, 28, 3
		};
		...
		public short[] copyToCurrentMap(int num){
			...
			for(int i = 0; i < level1data.length; i++){
				...
				case 1:
					currentMap[i] = level1data[i]; break;
				case 2:
					currentMap[i] = level2data[i]; break;
				case 3:
					currentMap[i] = level3data[i]; break;
					
				default: currentMap[i] = level1data[i]; break;
				}
			}
			return currentMap;
		}
